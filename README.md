...
A warm, neo-brutalist design system built on OKLCH color science. 3-tier token architecture (7 color families), 47+ components, full light/dark mode, a CSS motion system with 59 named animations, and a JS animation system with spring physics, FLIP transitions, particles, and gesture handling.
